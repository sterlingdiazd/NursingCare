        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DistanceFactor = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ComplexityLevel = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ClientBasePrice = table.Column<decimal>(type: "decimal(10,2)", nullable: true),
                    MedicalSuppliesCost = table.Column<decimal>(type: "decimal(10,2)", nullable: true),
                    ServiceDate = table.Column<DateOnly>(type: "date", nullable: true),
                    NurseId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    SuggestedNurse = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    AssignedNurse = table.Column<string>(type: "nvarchar(max)", nullable: true),
